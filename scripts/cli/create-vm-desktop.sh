...
echo az vm extension set --resource-group $resourceGroup --vm-name ${USER}-$1 --name CustomScript --publisher Microsoft.Azure.Extensions --version 2.0 --protected-settings ./create-vm-desktop.json
